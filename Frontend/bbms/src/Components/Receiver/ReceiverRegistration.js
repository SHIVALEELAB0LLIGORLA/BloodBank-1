    ...
    if (!address) {
      ...
      return;
            ...
            const data={
                ...
                const url='http://localhost:60698/api/Receiver/Registration';
                ...
                }).catch((error)=>
                  {
                    ...
                    return(
                      <Fragment>
                        ...
                        <h2 className='rh2'>Registration</h2>
                          ...
                          <div className="rform-group">
                            ...
                            <input className='rinput' type="age" value={age} onChange={(e) => setAge(e.target.value)} />
                            </div>
                            <div className="rform-group">
                            <label className='rlabel'>Gender:</label>
                            
                            <select className='rinput' name="Gender" id="gender" onChange={(e) => setGender(e.target.value)}>
                        ...
                        <option value="Male">Male</option>
                          ...
                          <div className="rform-group">
                            ...
                            <input className='rinput' type="email" value={email} onChange={(e) => setEmail(e.target.value)} />
                          </div>
                          <div className="rform-group">
                            <label className='rlabel'>Mobile:</label>
                            <input className='rinput' type="mobile" value={mobile} onChange={(e) => setMobile(e.target.value)} />
                            </div>
                            <div className="rform-group">
                            <label className='rlabel'>Address:</label>
                            <input className='rinput' type="address" value={address} onChange={(e) => setAddress(e.target.value)} />
                            </div>
                            {errorMessage && <p className="rerror-message">{errorMessage}</p>}
                         
        <button className='rbutton' onClick={()=> handleReceiverRegister()}>Register</button>
        <br></br>
          <p>Already have an account <a href='/ReceiverLogin'>SignIn</a></p>
